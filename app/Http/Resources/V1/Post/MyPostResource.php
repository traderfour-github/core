...
use Briofy\FileSystem\Http\Resources\AttachmentSummaryResource;
...
class MyPostResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'attachments'    => AttachmentSummaryResource::collection($this->attachments),
            'readDuration'   => Str::readDuration($this->title , $this->content)
        ];
    }
}
