...
return [
    'respond' => [
        ...
        // mt platform
        'bridge_response_mql'   => 'No response was received from mql side.',
        'bridge_response_client'   => 'No response was received from Client side.',
        'mtRest_response' => "There is a problem in calculating the final result of your request"
    ],
];
